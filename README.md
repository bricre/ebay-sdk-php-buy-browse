# (Unofficial) eBay API client (PHP) - Buy / Browse
...
Please refer to [eBay's documentation](https://developer.ebay.com/api-docs/buy/browse/overview.html) for detailed API behaviour explanation.
...
Client::configure(
    new \GuzzleHttp\Client([
        'base_uri' => 'https://api.ebay.com/buy/browse/v1/',
        'headers'=>[
