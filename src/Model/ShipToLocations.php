...
class ShipToLocations extends AbstractModel
{
     ...
     * well as the shipping regions that are under the regionExcluded to see where the
     * seller is willing to ship items. Sellers can specify that they ship 'Worldwide',
     * but then add several large geographical regions (e.g. Asia, Oceania, Middle
     * East) to the exclusion list, or sellers can specify that they ship to Europe and
     * Africa, but then add several individual countries to the exclusion list.
     *
     * @var \Ebay\Buy\Browse\Model\ShipToRegion[]
     */
